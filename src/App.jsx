...
function Card({ heading, sub, right, children }) {
  return (
    <div className="group rounded-2xl border bg-white/70 backdrop-blur p-6 shadow-sm hover:shadow-md transition-shadow">
    ...
    <div className="relative">
      ...
      <div className="mx-auto max-w-5xl px-4 pt-10 pb-6">
        <motion.div variants={fade} initial="hidden" animate="show">
          ...
          <p className="mt-4 max-w-2xl text-neutral-800 leading-7">{data.blurb}</p>
